  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "#307045",
      }}
    >
      {cols.map((h, i) => (
        <span key={h} className={`text-xs font-semibold text-white ${i === 0 ? "text-left" : "text-center"}`}>
          {h}
        </span>
      ))}
    </div>
...
export default function RekomendasiModal({ onClose, sessionId, khsResult }: RekomendasiModalProps) {
  ...
  // Prioritaskan data dari response API, fallback ke khsResult prop
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-end" onClick={onClose}>
      ...
      <div
        className="relative bg-white shadow-xl w-120 flex flex-col overflow-hidden h-full"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-0.5">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="text-xs px-2 py-0.5 rounded-full text-white font-medium" style={{ backgroundColor: "#307045" }}>
                        {prodi}
                      </span>
                    </div>
              ...
              {loadState === "error" && (
                <div className="flex flex-col gap-2">
                  ...
                  <button
                    ...
                    className="text-xs text-center py-2 rounded-xl border border-gray-200 text-gray-500 hover:bg-gray-50 transition-colors"
                  >
                    Coba lagi
                  </button>
                </div>
